...
const ArtisticContactHero = () => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-[url('https://images.pexels.com/photos/7130499/pexels-photo-7130499.jpeg?auto=compress&cs=tinysrgb&w=1600')] bg-cover bg-center opacity-[0.08] mix-blend-screen" />
        ...
        <div ref={panelRef} className="relative overflow-hidden ">
          <div className="relative">
            <h1 className="hero-title text-4xl font-semibold leading-[1.02] text-white sm:text-5xl lg:text-5xl">
              A contact hero that feels like a gallery wall.
            </h1>
...
export default ArtisticContactHero;
