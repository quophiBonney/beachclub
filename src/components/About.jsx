...
const BookingModal = ({ open, onClose, activeSlide }) => {
  ...
  useEffect(() => {
    if (open) {
      setFormData((prev) => ({
        ...prev,
        roomType: activeSlide?.title ? "Deluxe Beach View" : prev.roomType,
      }));
    }
  }, [open, activeSlide]);
        ...
        <div className="grid grid-cols-1">
          {/* <div className="relative hidden min-h-full overflow-hidden lg:block">
            <img
              ...
              alt={activeSlide?.title || "Booking preview"}
            ...
            <div className="absolute inset-x-0 bottom-0 p-8 text-white">
              ...
              <h3 className="mt-2 text-3xl font-bold">
                {activeSlide?.title || "Golden Coast Escape"}
              </h3>
              <p className="mt-3 max-w-md text-sm leading-7 text-white/80">
                {activeSlide?.text ||
                  "A refined booking experience with calm visuals and premium presence."}
              </p>
            </div>
          </div> */}
            ...
            <div className="flex items-start justify-between border-b border-slate-200 px-6 py-5 sm:px-8">
              <div>
                ...
                <p className="mt-2 text-sm text-slate-500">
                  Tell us your preferred dates and we will prepare the rest.
                </p>
              </div>
